  ...
  return (
    <div className="background">
      ...
      <div className="layout-body">
        ...
        {/* Barra Esquerda */}
        {LeftContent.isVisible && (
          <>
            <aside
              className={`left-bar ${LeftContent.isVisible ? 'active' : ''}`}
              style={LeftContent.isVisible ? { width: leftWidth } : {}}
            >
              {LeftContent.content}
            </aside>
        ...
        <div className="main-body">
          <main className="main-window">{MainContent.content}</main>

          {/* Puxador do Footer (Fica no topo do footer) */}
          {FooterContent.isVisible && <div className="resizer-vertical" onMouseDown={startResize('footer')} />}

          <footer className="resizable-footer" style={{ height: footerHeight, display: FooterContent.isVisible ? undefined : 'none' }}>
            {FooterContent.content}
          </footer>
        </div>

        {/* Puxador da Direita + Barra Direita */}
        {RightContent.isVisible && (
          <>
